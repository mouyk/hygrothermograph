...
int data_handle(unsigned short offset)
{
  ...
  switch(cmd_type)
  {
	  	case ZIGBEE_FACTORY_NEW_CMD:{
		    zigbee_notify_factory_new_hanlde(); // response
		}
		break;
...
/**
* @brief mcu send a cmd which used to making zigbee module reset
* @param[in] {void}
* @return  void
*/
...
/**
* @brief mcu send this commond starting zigbee module join network
